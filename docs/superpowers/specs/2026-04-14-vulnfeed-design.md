...
Python script + GitHub Actions + GitHub Pages. Python was chosen for its clean syntax, good libraries (`feedgen`, `requests`), and ease of modification for anyone forking the repo. Testing with `pytest`, linting and formatting with `ruff`.
